      ...
      {view === 'landing' ? (
        <>
          ...
          <div style={{ padding: '40px 60px', display: 'flex', flexDirection: 'column', gap: '30px', position: 'relative' }}>
            ...
            {/* Partner / Brand Logos Row (Exact match to reference image) */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '15px', fontSize: '12px', fontWeight: 'bold', fontFamily: 'monospace', color: '#374151', flexWrap: 'wrap' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '40px', alignItems: 'center' }}>
              ...
              {/* Right Side Retro Hacker Illustration Box (Matching reference image artwork) */}
              <div style={{ background: '#064e3b', border: '3px solid #111827', borderRadius: '20px', padding: '30px', minHeight: '240px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', boxShadow: '8px 8px 0px #111827', position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ textAlign: 'center', margin: '20px 0' }}>
                  <div style={{ fontSize: '28px', fontWeight: '900', color: '#fff', fontFamily: 'monospace' }}>CODEBAND HACK</div>
                  <div style={{ fontSize: '12px', color: '#a7f3d0', marginTop: '6px' }}>Autonomous Multi-Agent Systems & Keyboards</div>
                </div>
          ...
          {/* BOTTOM METRICS BAR (Exact match to reference image bottom layout) */}
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', borderTop: '3px solid #111827', background: '#fff' }}>
            ...
            <div style={{ padding: '24px 30px', borderRight: '3px solid #111827' }}>
              ...
              <div style={{ fontSize: '18px', fontWeight: '900', color: '#111827' }}>ONLINE</div>
            </div>
            ...
            <div style={{ padding: '24px 30px', background: '#111827', color: '#fff' }}>
              ...
              <div style={{ fontSize: '18px', fontWeight: '900', color: '#34d399' }}>$ 10,000+</div>
            </div>
